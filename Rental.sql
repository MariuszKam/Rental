...
CREATE TABLE IF NOT EXISTS `Rental`.`Feedback` (
  ...
  `Rental_Deal_id` BIGINT UNSIGNED NOT NULL,
  `Customer_id` BIGINT UNSIGNED NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `Rental`.`Rental_Deal_has_Vehicle`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Rental`.`Rental_Deal_has_Vehicle` (
  `id` BIGINT UNSIGNED NOT NULL,
  `Rental_Deal_id` BIGINT UNSIGNED NOT NULL,
  `Vehicle_id` BIGINT UNSIGNED NOT NULL,
  INDEX `fk_Rental_Deal_has_Vehicle_Vehicle1_idx` (`Vehicle_id` ASC) VISIBLE,
  INDEX `fk_Rental_Deal_has_Vehicle_Rental_Deal1_idx` (`Rental_Deal_id` ASC) VISIBLE,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
  CONSTRAINT `fk_Rental_Deal_has_Vehicle_Rental_Deal1`
    FOREIGN KEY (`Rental_Deal_id`)
    REFERENCES `Rental`.`Rental_Deal` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Rental_Deal_has_Vehicle_Vehicle1`
    FOREIGN KEY (`Vehicle_id`)
    REFERENCES `Rental`.`Vehicle` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
